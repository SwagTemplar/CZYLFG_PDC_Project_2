...
// Constructor setting size to invview
    ...
    public ViewOrdersPanel(InvView invview) {
    ...
    private void components() {
        ...
        message.setText("Viewing current orders");

        // adds scrollpane and textarea to display database content of order that have been placed
